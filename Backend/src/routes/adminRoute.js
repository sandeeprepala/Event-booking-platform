...
import { createEvent, editEvent, getAllEventsForAdmins,totalEventWiseRevenue,sendZoomLinkEmail } from "../controllers/admin.controller.js";
...
adminRouter.route("/sendLink").post(verifyJWT, isAdmin, sendZoomLinkEmail);
